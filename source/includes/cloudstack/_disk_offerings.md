...
curl -X GET \
   ...
   "https://portal.coxedge.com/api/v2/services/compute-on/test_area/diskofferings"
```
...
curl -X GET \
   -H "MC-Api-Key: your_api_key" \
   "https://portal.coxedge.com/api/v2/services/compute-on/test_area/diskofferings/18bbab50-8d85-4b34-8361-0dc223ffd7e5"
```
> The above command returns a JSON structured like this:
