...
curl -X GET \
   ...
   "https://portal.coxedge.com/api/v2/services/compute-on/test_area/zones"
```
...
curl -X GET \
   -H "MC-Api-Key: your_api_key" \
   "https://portal.coxedge.com/api/v2/services/compute-on/test_area/zones/ea901007-056b-4c50-bb3a-2dd635fce2ab"
```
> The above command returns a JSON structured like this:
