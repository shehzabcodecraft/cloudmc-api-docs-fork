...
curl -X GET \
  ...
  "https://portal.coxedge.com/api/v2/services/compute-on/test_area/affinitygroups"
```
...
curl -X GET \
   -H "MC-Api-Key: your_api_key" \
   "https://portal.coxedge.com/api/v2/services/compute-on/test_area/affinitygroups/d4fd794f-66e1-4906-a720-d0afb04bd517"
```
> The above command returns a JSON structured like this:
