...
curl "https://portal.coxedge.com/rest/billing_providers" \
...
```shell
# Retrieve a billing provider's details
curl "https://portal.coxedge.com/rest/billing_providers/f26e66a4-755c-4867-b565-ad68aa515237" \
   -H "MC-Api-Key: your_api_key"
```
> The above command returns a JSON structured like this:
...
curl -X POST "https://portal.coxedge.com/rest/billing_providers" \
   -H "MC-Api-Key: your_api_key"
```
...
curl -X PUT "https://portal.coxedge.com/rest/billing_providers/c84cfe41-929b-47c9-bde4-b55a10bd2774" \
   -H "MC-Api-Key: your_api_key"
```
...
```shell
curl --request DELETE \
  --url https://portal.coxedge.com/rest/billing_providers/f9a2b02b-7d67-4910-8353-c4bfcbdeaa7e \
