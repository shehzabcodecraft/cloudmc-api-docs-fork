...
curl "https://portal.coxedge.com/api/v2/content/notifications?language=:language&organization_id=:organiationId" \
...
curl "https://portal.coxedge.com/api/v2/content/notifications/:id?language=:language" \
   -H "MC-Api-Key: your_api_key"
```
> The above command returns JSON structured like this:
...
```shell
# Create notification
curl -X POST "https://portal.coxedge.com/api/v2/content/notifications/" \
   -H "MC-Api-Key: your_api_key" \
...
```shell
# Update notification
curl -X PUT "https://portal.coxedge.com/api/v2/content/notifications/:id" \
   -H "MC-Api-Key: your_api_key" \
   -H "Content-Type: application/json" \
   -d "request-body"
```
