...
curl --request GET \
  --url http://portal.coxedge.com/rest/navigation/:id \
...
curl --request GET \
  --url http://portal.coxedge.com/rest/navigation/f8663571-1d84-4d48-bb86-d4e2a14ea9f9 \
  --header 'Content-Type: application/json' \
  --header 'Mc-Api-Key: your_api_key'
```
...
```shell 
  --request POST \
  --url http://portal.coxedge.com/rest/navigation \
  --header 'Content-Type: application/json' \
  --header 'Mc-Api-Key: your_api_key' \
  --data '{
  "enabled": true,
...
```shell 
curl --request PUT \
  --url http://portal.coxedge.com/rest/navigation/e80adf4d-5401-4cff-b393-93a7f10f4d71 \
  --header 'Content-Type: application/json' \
  --header 'Mc-Api-Key: your_api_key' \
  --data '{
	"id": "e80adf4d-5401-4cff-b393-93a7f10f4d71",
