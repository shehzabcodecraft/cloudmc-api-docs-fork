...
curl -X GET \
   ...
   "https://portal.coxedge.com/api/v1/services/descriptors/gcp/parameters"
```
...
curl -X POST "https://portal.coxedge.com/api/v1/services/connections" \
   -H "MC-Api-Key: your_api_key" \
...
curl -X POST "https://portal.coxedge.com/api/v1/services/connections/test" \
   -H "MC-Api-Key: your_api_key" \
   -H "Content-Type: application/json" \
   -d "request_body"
```
...
curl -X POST "https://portal.coxedge.com/api/v1/services/connections/9571b279-abaf-4a37-9f39-85d1a915af7d/test" \
   -H "MC-Api-Key: your_api_key" \
   -H "Content-Type: application/json"
```
...
```shell
# Retrieve connection policy descriptors
curl "https://portal.coxedge.com/api/v1/services/connections/03bc22bd-adc4-46b8-988d-afddc24c0cb5/policies/descriptors?section=trials" \
   -H "MC-Api-Key: your_api_key"
```
...
curl -X PUT \
   ...
   "https://portal.coxedge.com/api/v1/services/connections/03bc22bd-adc4-46b8-988d-afddc24c0cb5/policies"
```
> The above command returns a JSON structured like this:
