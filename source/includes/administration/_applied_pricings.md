...
curl "https://portal.coxedge.com/rest/applied_pricings" \
...
```shell
# Retrieve an applied pricing
curl "https://portal.coxedge.com/rest/applied_pricings/03bc22bd-adc4-46b8-988d-afddc24c0cb5" \
   -H "MC-Api-Key: your_api_key"
```
> The above command returns a JSON structured like this:
...
curl -X POST "https://portal.coxedge.com/rest/applied_pricings" \
   -H "MC-Api-Key: your_api_key"
```
...
curl -X PUT "https://portal.coxedge.com/rest/applied_pricings/8bb5e457-41c3-410b-aced-b9c694ff141a" \
   -H "MC-Api-Key: your_api_key"
```
...
```shell
curl -X DELETE "https://portal.coxedge.com/rest/applied_pricings/d08b9332-d26e-42fe-b272-3071f2d64839" \
   -H "MC-Api-Key: your_api_key"
```
