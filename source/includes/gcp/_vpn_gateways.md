...
curl -X GET \
   ...
   "https://portal.coxedge.com/api/v2/services/gcp/test-area/vpngateways"
```
...
curl -X GET \
   -H "MC-Api-Key: your_api_key" \
   "https://portal.coxedge.com/api/v2/services/gcp/test-area/vpngateways/3112849056897469664"
```
> The above command returns a JSON structured like this:
