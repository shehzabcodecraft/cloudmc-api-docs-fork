...
curl -X GET \
   ...
   "https://portal.coxedge.com/api/v2/services/gcp/test-area/instancegroups"
```
...
curl -X GET \
   -H "MC-Api-Key: your_api_key" \
   "https://portal.coxedge.com/api/v2/services/gcp/test-area/instancegroups/2986056884972096897"
```
> The above command returns a JSON structured like this:
...
curl -X POST \
   -H "MC-Api-Key: your_api_key" \
   -d "request_body" \
   "https://portal.coxedge.com/api/v2/services/gcp/test-area/instancegroups/2986056884972096897?operation=manage_instance_members"
```
> Request body example:
