...
curl -X GET \
  ...
  "https://portal.coxedge.com/api/v2/services/gcp/test-area/healthchecks"
```
...
curl -X GET \
   -H "MC-Api-Key: your_api_key" \
   "https://portal.coxedge.com/api/v2/services/gcp/test-area/healthchecks/5930212998788364011"
```
> The above command returns a JSON structured like this:
...
curl -X DELETE \
   -H "MC-Api-Key: your_api_key" \
   "https://portal.coxedge.com/api/v2/services/gcp/test-area/healthchecks/6938691570659391640"
```
