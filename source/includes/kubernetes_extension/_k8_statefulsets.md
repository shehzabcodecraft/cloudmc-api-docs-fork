...
curl -X GET \
   ...
   "https://portal.coxedge.com/api/v2/services/a_service/an_environment/statefulsets?cluster_id=a_cluster_id"
```
...
curl -X GET \
   -H "MC-Api-Key: your_api_key" \
   "https://portal.coxedge.com/api/v2/services/a_service/an_environment/statefulsets/test-aerospike/auth?cluster_id=a_cluster_id"
```
...
curl -X PUT \
  -H "MC-Api-Key: your_api_key" \
   "https://portal.coxedge.com/api/v2/services/a_service/an_environment/statefulsets/stateful-set-name/default"
  Content-Type: application/json
  {
  "apiVersion": "apps/v1",
  "kind": "StatefulSet",
...
curl -X DELETE \
   -H "MC-Api-Key: your_api_key" \
   "https://portal.coxedge.com/api/v2/services/a_service/an_environment/statefulsets/my-aerospike/default"
```
