...
curl -X GET \
  ...
  "https://portal.coxedge.com/api/v2/services/edge-services/test-area/networkpolicyrules"
```
...
curl -X GET \
  -H "MC-Api-Key: your_api_key" \
  "https://portal.coxedge.com/api/v2/services/edge-services/test-area/networkpolicyrules/2ac958f2-0976-4de9-95f6-3546fc10f8d0/INBOUND/-812331665/0"
```
